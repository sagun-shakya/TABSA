...
DESCRIPTION:
    The main task is to label each token to one of the following ASPECT CATEGORIES.
    - {  'B-FEEDBACK',
         'B-GENERAL',
         'B-PROFANITY',
         'B-VIOLENCE',
...
early_stopping = EarlyStopping(patience = 3, 
                               verbose = True, 
                               delta = 0.0001, 
                               path = os.path.join(os.path.dirname(__file__), r'checkpoints', r'aspect', r'checkpoint.pt'))
