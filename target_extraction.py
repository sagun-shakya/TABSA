# -*- coding: utf-8 -*-
"""
Created on Tue Dec  7 09:16:51 2021
...
data = get_file_in_df(filename, mode = 'target')
...
early_stopping = EarlyStopping(patience = 3, 
                               verbose = True, 
                               delta = 0.0001, 
                               path = os.path.join(os.path.dirname(__file__), r'checkpoints', r'target', r'checkpoint.pt'))
