...
def train(args):
    ...
    preprocessor = Preprocessor(config_dir = args.corpus_dir, 
                                save_config_dir = args.model_dir, 
                                verbose=True)
    ...
    # datasets
    (x_train, y_train), (x_val, y_val), (x_test, y_test) = preprocessor.load_dataset(args.corpus_dir, 
                                                                                     args.val_split, 
                                                                                     args.test_split, 
